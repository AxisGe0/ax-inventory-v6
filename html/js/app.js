...
(() => {
    ...
    Inventory.Clickables = function(){
        ...
        $('.cloth').find('img').click(function(){
            $.post("http://ax-inventory/ChangeComponent", JSON.stringify({
    ...
    Inventory.Necessary = function(){
        ...
        $('#clothswitch').click(function(){
            if (isClothOpen == false){
                isClothOpen = true
                $.post("http://ax-inventory/OpenClothMenu", JSON.stringify({delete:isClothOpen}));
